	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'sunshine':
			{
				defaultCamZoom = 0.9;
				curStage = 'sunshine';
				var bg:FlxSprite = new FlxSprite(-100, 0).loadGraphic(Paths.image('bob/happysky'));
				bg.updateHitbox();
				bg.active = false;
				bg.antialiasing = true;
				bg.scrollFactor.set(0.1, 0.1);
			...
			case 'withered':
			{
				defaultCamZoom = 0.9;
				curStage = 'withered';
				var bg:FlxSprite = new FlxSprite(-100, 0).loadGraphic(Paths.image('bob/slightlyannyoed_sky'));
				bg.updateHitbox();
				bg.active = false;
				bg.antialiasing = true;
				bg.scrollFactor.set(0.1, 0.1);
			...
			case 'run':
			{
				defaultCamZoom = 0.9;
				curStage = 'hellstage';
				var bg:FlxSprite = new FlxSprite(-100, 0).loadGraphic(Paths.image('bob/hell'));
				bg.updateHitbox();
				bg.active = false;
				bg.antialiasing = true;
				bg.scrollFactor.set(0.1, 0.1);
				...
				var thingidk:FlxSprite = new FlxSprite(-271, 0).loadGraphic(Paths.image('bob/middlething'));
			...
			case 'onslaught':
			{
				defaultCamZoom = 0.9;
				curStage = 'onslaught';
				var bg:FlxSprite = new FlxSprite(-100, 0).loadGraphic(Paths.image('bob/scary_sky'));
				bg.updateHitbox();
				bg.active = false;
				bg.antialiasing = true;
				bg.scrollFactor.set(0.1, 0.1);
